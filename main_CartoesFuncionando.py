...
ids = {'0x94006b1a': ['Chaveiro', 'Cauã Veiga','Liberado',0],
       '0x9351e2ec': ['Cartão','Rafael Lobão','Negado',0]}
        ...
        if stat == rdr.OK:
            ...
            if stat == rdr.OK:
                ...
                # Para o caso em que foi negado (não terá como saber se está a entrar ou sair)
                    ...
                    info = {'value1':card_id, 'value2':id[card_id][1]}
                    request_headers = {'Content-Type': 'application/json'}
                    request = urequests.post('https://maker.ifttt.com/trigger/cartao/with/key/' + api_key,
